...
// Answer
// current rendition ,The methods will change the value of this in functions.which is the current 
// 2. What is "this" when joe.scopeArrow() is invoked?
// Answer
//  The methods will  not change the value of this in functions . so in this case the old version of the student object

// 3. Explain why "this" is different when an arrow function is used.
// Answer
// this keyword works differently in arrow functions. The methods will not change the value of this in arrow functions.
//  it will be the same value as when the function was called.)